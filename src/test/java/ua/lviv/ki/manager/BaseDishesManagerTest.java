...
public abstract class BaseDishesManagerTest {
  ...
  public void createDishes() {
    ...
    dishes.add(new Hamburger(450, 500, 9, 125, "Hamburger", DishType.NON_VEGETERIAN, 2, 1));
    dishes.add(new Pizza(500, 550, 8, 120, "Pizza", DishType.NON_VEGETERIAN, 6, 2));
    dishes.add(new Salad(250, 420, 6, 70, "Salad", DishType.VEGETERIAN, 70, 3));
    dishes.add(new CocaCola(500, 120, 7, 18, "CocaCola", DishType.BABY_FRIENDLY, 75, 4));
    dishes.add(new Juice(500, 50, 5, 25, "Juice", DishType.BABY_FRIENDLY, JuiceType.APPLE, 5));
  }
